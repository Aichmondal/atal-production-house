...
export const SocialSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="relative py-24 bg-[#0A0A0A] border-t border-white/5">
          ...
          {socialChannels.map((item) => {
            ...
            return (
              <a
                ...
                className="group rounded-3xl bg-white/5 p-6 border border-white/10 transition-all duration-300 flex flex-col justify-between hover:-translate-y-1.5 hover:border-white/20 hover:bg-white/[0.08] shadow-lg"
              >
                <div>
                  ...
                  <h3 className="font-bold text-lg text-white mb-1 group-hover:text-[#D4AF37] transition-colors">
                    {item.label}
                  </h3>
                ...
                <div className="pt-3 border-t border-white/5 flex items-center justify-between text-xs font-semibold text-neutral-300 group-hover:text-[#D4AF37] transition-colors">
